...
* Altere o arquivo main.js de forma que a variável "formSubmitURL" tenha o endereço do servidor em questão, que receberá os dados capturados.
...
* Se todos os passos foram seguidos corretamente, a extensão foi instalada. Se ela não for automaticamente ativa, faça-o.
